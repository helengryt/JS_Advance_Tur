...
function getRandomColor(){
  ...
  document.body.style.backgroundColor = '#' + r.toString(16) + g.toString(16) + b.toString(16);
}
...
button.innerText = 'Изменить цвет'; 
...
divA.className = 'middle';
divA.style.width = '200px';
divA.style.height = '200px';
divA.innerText = "anytext";
divA.style.margin = 'auto';
//divA.style.backgroundColor = 'black';

document.body.appendChild(divA);

button.addEventListener('click', () => getRandomColor2());